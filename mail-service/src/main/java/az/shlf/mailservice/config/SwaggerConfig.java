package az.shlf.mailservice.config;
...
public class SwaggerConfig {
   ...
   public OpenAPI customOpenAPI() {
      ...
      return new OpenAPI()
              .info(new Info()
                      .title("Invest App ms (Mail-sender-service) API")
                      .version("1.0")
                      .description("API documentation for Invest App's Mail-Sender-service with Multilingual Support"))
